...
namespace FinalProject
{
    class Hero
    {
        ...
        public Hero(string name, string power, string nemesis)
        {
            this.Name = name;
            this.Power = power;
        ...
        //Add increaseAmount to this.PowerLevel and return the new value for this.PowerLevel 
        //(try to use a loop calling the other ChargePower)
        public int ChargePower(int increaseAmount)
        {
            this.PowerLevel = 100;
            Console.WriteLine("Charging power level, its over 9000!!!!");
            return PowerLevel++;
        }
